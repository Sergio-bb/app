...
public class HeightProviderActivity extends PopupWindow implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public HeightProviderActivity(Activity activity) {
        super(activity);
    ...
    public HeightProviderActivity init() {
        if (!isShowing()) {
    ...
    public HeightProviderActivity setHeightListener(HeightListener listener) {
