...
public class RequestMensajeReposicionTarjeta extends BaseRequest {
    ...
    public RequestMensajeReposicionTarjeta() {
    }

    public RequestMensajeReposicionTarjeta(String cedula, String token, String f_inicio, String f_final, String n_tipo, String n_mensaj) {
        super(cedula, token);
