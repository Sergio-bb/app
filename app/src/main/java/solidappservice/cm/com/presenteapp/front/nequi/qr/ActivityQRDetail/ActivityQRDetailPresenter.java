...
public class ActivityQRDetailPresenter implements ActivityQRDetailContract.Presenter, ActivityQRDetailContract.APIListener {

    ActivityQRDetailView view;
    ActivityQRDetailModel model;

    public ActivityQRDetailPresenter(ActivityQRDetailView view, ActivityQRDetailModel model) {
        this.view = view;
        this.model = model;
    }
