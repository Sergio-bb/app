 ...
 */
public class ActivityHtmlModel implements ActivityHtmlContract.Model{

    @Override
    public void getSuscriptionNequi(BaseRequest body, final ActivityHtmlContract.APIListener listener) {
    ...
    @Override
    public void getTimeExpiration(final ActivityHtmlContract.APIListener listener ){
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(NetworkHelper.NEQUI_WS)
                .addConverterFactory(GsonConverterFactory.create())
                .build();
    ...
    @Override
    public void getMinutesOfSuscription(BaseRequestNequi body, final ActivityHtmlContract.APIListener listener ){
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(NetworkHelper.NEQUI_WS)
                .addConverterFactory(GsonConverterFactory.create())
                .build();
