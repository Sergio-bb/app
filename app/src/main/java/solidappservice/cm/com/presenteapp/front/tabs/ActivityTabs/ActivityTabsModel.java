...
public class ActivityTabsModel implements ActivityTabsContract.Model {

    @Override
    public void getSuscriptionNequi(BaseRequest body, final ActivityTabsContract.APIListener listener) {
    ...
    @Override
    public void getTimeExpiration(final ActivityTabsContract.APIListener listener ){
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(NetworkHelper.NEQUI_WS)
                .addConverterFactory(GsonConverterFactory.create())
                .build();
    ...
    @Override
    public void getMinutesOfSuscription(BaseRequestNequi body, final ActivityTabsContract.APIListener listener ){
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(NetworkHelper.NEQUI_WS)
                .addConverterFactory(GsonConverterFactory.create())
                .build();
