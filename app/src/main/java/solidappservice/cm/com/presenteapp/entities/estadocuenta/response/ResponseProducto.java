...
public class ResponseProducto {
    ...
    public ResponseProducto(String aanumnit, String n_tipodr, String a_tipodr, String k_tipodr, String a_numdoc,
    ...
    public ResponseProducto(String n_produc, String a_numdoc, String n_tipodr, double v_saldo) {
        this.n_produc = n_produc;
        this.a_numdoc = a_numdoc;
        this.n_tipodr = n_tipodr;
        this.v_saldo = v_saldo;
