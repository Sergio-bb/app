 ...
 */
public class ActivityTermsAndConditionsModel implements ActivityTermsAndConditionsContract.Model{
    ...
    public void registerAcceptedTermsAndConditions(RequestAceptaTyC body, final ActivityTermsAndConditionsContract.APIListener listener) {
        try {
            ...
            Call<BaseResponse<String>> call = service.registerAcceptedTermsAndConditions(body);
