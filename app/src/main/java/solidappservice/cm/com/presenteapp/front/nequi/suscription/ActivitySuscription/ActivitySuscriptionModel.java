...
public class ActivitySuscriptionModel implements ActivitySuscriptionContract.Model {

    @Override
    public void getSuscriptionNequi(BaseRequest body, final ActivitySuscriptionContract.APIListener listener) {
    ...
    @Override
    public void getTimeExpiration(final ActivitySuscriptionContract.APIListener listener ){
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(NetworkHelper.NEQUI_WS)
                .addConverterFactory(GsonConverterFactory.create())
                .build();
    ...
    @Override
    public void getMinutesOfSuscription(BaseRequestNequi body, final ActivitySuscriptionContract.APIListener listener ){
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(NetworkHelper.NEQUI_WS)
                .addConverterFactory(GsonConverterFactory.create())
                .build();
